            ...
            <div className={styles.footerSection1}>
                <div className={styles.footerSection1Sub1}>
                    ...
                    <div>
                        ...
                        <div className={styles.address}>3310 W Empedrado St</div>
                        <div className={styles.address}>Tampa, FL 33629</div>
                    </div>
                </div>
                <div className={styles.footerSection1Sub2}>
                    ...
                    <div className={styles.footerList2}>
                        ...
                        <ul>
                            ...
                            <li><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-youtube" viewBox="0 0 16 16">
